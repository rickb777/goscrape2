...
func TestGetFilePath(t *testing.T) {
	...
	var cases = []struct {
		...
		{isAPage: false, downloadURL: must("https://github.com/test/info.aspx#fragment"), expected: "./test/info.aspx"},
		{isAPage: false, downloadURL: must("https://github.com/test/info.aspx?a=1&b=2&b=3#fragment"), expected: "./test/info_a=1_b=2_b=3.aspx"},
		{isAPage: false, downloadURL: must("https://github.com/?a=1&b=2&b=3#fragment"), expected: "./a=1_b=2_b=3.html"},
		// edge cases
...
func TestGetPageFilePath(t *testing.T) {
	...
	var cases = []struct {
		...
		{downloadURL: must("https://github.com/test/info.aspx#fragment"), expected: "/test/info.aspx"},
		{downloadURL: must("https://github.com/test/info.aspx?a=1&b=2&b=3#fragment"), expected: "/test/info_a=1_b=2_b=3.aspx"},
